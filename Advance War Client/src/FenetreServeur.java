...
public class FenetreServeur extends JFrame implements ActionListener
{
	...
	/*
	 *  Constructeur plsr parametre
	 */
	private Menu owner;
	public FenetreServeur(Menu owner){
		this();
		this.owner=owner;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			String fileName;
			JFileChooser jfc = new JFileChooser(System.getProperty("user.dir",".")+"/mapServeur");
			...
			//		IP HOTE :
								...
								try {
									ipHote = InetAddress.getByName("127.0.0.1");
								} catch (UnknownHostException e2) {
									// TODO Auto-generated catch block
									e2.printStackTrace();
								}
			/////////////////////////////////////////////////////////////////////////////////////////////////////////
			ConnectionAuServeur cAS = new ConnectionAuServeur(ipHote,8811,new RejoindreUnePartie(owner));
